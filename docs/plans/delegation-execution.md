...
These components remain behind the production execution gate. Ordinary main/setup/review/discovery admission still needs the same global capacity and durable quarantine reconstruction; proposals/presets, visible run controls, result-query surfaces, repair generations, and installed desktop end-to-end delegation acceptance remain required before enablement.
