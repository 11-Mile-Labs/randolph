...
import type { AdapterEvent, Conversation, HarnessId, HarnessInfo, HarnessSelection, Project, Run, SendInput } from './contracts.js';
...
export type RuntimeBindings = {
  ...
  changed(): void;
  prepareSend(input: SendInput, setup?: { executable?: string; expectedContextRevision: string | null }): Promise<Run>;
