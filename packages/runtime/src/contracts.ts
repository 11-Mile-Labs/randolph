...
export type ProjectHarnessSettings = { revision: string | null; defaults: ProjectHarnessDefaults | null; enabledRoutes?: HarnessRoute[]; error?: string };
export type SaveProjectDefaultsInput = { projectId: string; defaults: ProjectHarnessDefaults; enabledRoutes?: HarnessRoute[]; expectedRevision: string | null };
...
export type ProjectSetupSnapshot = { cleanup?: { canReconcile: boolean; reason: string }; context: ProjectContextSnapshot; inspections: ProjectInspection[] };
