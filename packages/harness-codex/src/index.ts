...
const bounded = (value: unknown, limit = 16_384): string =>
...
const identitiesAgree = (first: string | undefined, second: string | undefined): boolean =>
  !first || !second || first === second;
const hasOwn = (value: Json, key: string): boolean =>
...
function runNotificationIdentity(
  method: string,
  params: Json,
