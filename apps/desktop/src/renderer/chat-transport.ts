...
import type { DesktopBridge, Run, WorkspaceSnapshot } from '@randolph/runtime/contracts';

type ChatBridge = Pick<DesktopBridge, 'snapshot' | 'chatEvents' | 'send' | 'stop' | 'onChanged'>;
