...
const bridge: DesktopBridge = {
  ...
  saveDelegationPreset: async input => ipcRenderer.invoke('randolph:save-delegation-preset', input),
  ...
  reconcileProjectSetupCleanup: async id => ipcRenderer.invoke('randolph:reconcile-setup-cleanup', id),
  ...
  harness: async (projectId, executable, harnessId) => ipcRenderer.invoke('randolph:harness', { projectId, executable, harness: harnessId }),
  harnessInstallations: async harnessId => ipcRenderer.invoke('randolph:harness-installations', { harness: harnessId }),
